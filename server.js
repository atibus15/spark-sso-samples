...
var server_side = ejs.compile(str)({ "link": initiateURL }); // inject the link into the template

str = read(join(__dirname, '/www/client-side.ejs'), 'utf8');
var client_side = ejs.compile(str)({ "clientId": clientId, "clientSecret": clientSecret});

app.get("/client-side.html", function (req, res) {
    debug("serving the client-side app");
